...
public class trade_history extends HttpServlet {
    public trade_history(){ super();}
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(action.equals("get_trade_history")){
            try{
...
//                System.out.println("going to return!!!!!!!!");
        ...
        String sql="select * from business where user_name='"+user.getUsername()+"'";
        ...
        try{
            while(rs.next()){
                ...
                node.put("time",rs.getString("time"));
                arr.put(node);
